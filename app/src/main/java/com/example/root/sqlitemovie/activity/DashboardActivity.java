    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new
                        Intent(DashboardActivity.this,TambahDataActivity.class);
                startActivity(i);
            }
        });
        edata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i= new
                        Intent(DashboardActivity.this,EditDataActivity.class);
                startActivity(i);
            }
        });
        ldata.setOnClickListener(new View.OnClickListener() {@Override
        public void onClick(View view) {
            Intent i= new
                    Intent(DashboardActivity.this,LihatDataActivity.class);
            startActivity(i);
        }
        });
        hdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i= new
                        Intent(DashboardActivity.this,HapusDataActivity.class);
                startActivity(i);
            }
        });
    }
